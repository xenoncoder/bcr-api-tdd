...
module.exports = {
  ...
  // E.g. maxWorkers: 10% will use
  // 10% of your CPU amount + 1 as the maximum worker number.
  ...
  // or to arrays of module names that allow to stub out
  ...
  // A list of paths to snapshot serializer modules
